...
@NamedQueries({
    ...
    @NamedQuery(name = "Manager.findByIdToko", query = "SELECT m FROM Manager m WHERE m.idToko = :idToko")})
public class Manager implements Serializable {
    ...
    public Manager(String idManager, String namaManager, Character jenisKelamin, String alamat, String noTelp, String idToko) {
        this.idManager = idManager;
    ...
    public String toString() {
        return "tugas.cemilanconnectdb.Manager[ idManager=" + idManager + " ]";
    }
